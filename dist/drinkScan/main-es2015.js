    ...
    switchDisplay(obj) {
        ...
        switch (this.objType) {
            case 'i-text':
                ...
                setTimeout(() => {
                    this.fontPicker = new font_picker__WEBPACK_IMPORTED_MODULE_10__["default"]("AIzaSyAB_8iUhpGP-7Iagd-pT00dzjAF2Zy1SV8", // Google API key
...
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _services_assetsLib_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/assetsLib.service */ "./src/services/assetsLib.service.ts");
/* harmony import */ var _cloudinary_angular_5_x__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @cloudinary/angular-5.x */ "./node_modules/@cloudinary/angular-5.x/fesm2015/cloudinary-angular-5.x.js");
...
let ModalLibDialog = class ModalLibDialog {
    constructor(dialogRef, snackBar, assetsLib, cloudinary, data) {
        this.dialogRef = dialogRef;
        this.snackBar = snackBar;
        this.assetsLib = assetsLib;
        this.cloudinary = cloudinary;
    ...
    getCloudinary(src) {
        this.assetsLib.getCloudinary(src).subscribe((response) => {
            this.currentCat = src;
...
AssetsLibService.ctorParameters = () => [
